...
class f9 {
   ...
   */
  constructor() {
    this._isCulling = !1, this._isPremultipliedAlpha = !1, this._anisotropy = 0, this._model = null, this._modelColor = new g9(), this._useHighPrecisionMask = !1, this._mvpMatrix4x4 = new Y(), this._mvpMatrix4x4.loadIdentity();
  }
}
var Av;
(function(r) {
...
class I {
   ...
   */
  appendKey(v) {
    this.prepareCapacity(this._size + 1, !1), this._keyValues[this._size] = new Q9(v), this._size += 1;
  }
  /**
  ...
  static parseJsonObject(v, P) {
    return Object.keys(v).forEach((a) => {
      if (typeof v[a] == "boolean") {
        ...
        const e = Number(v[a]);
        P.put(a, new uv(e));
      } else v[a] instanceof Array ? P.put(a, sv.parseJsonArray(v[a])) : v[a] instanceof Object ? P.put(a, sv.parseJsonObject(v[a], new H())) : v[a] == null ? P.put(a, new X()) : P.put(a, v[a]);
    }), P;
  }
...
class Lv {
  ...
  static initialize(v = 0) {
    ...
    d.staticInitializeNotForClientCall(), vv = new u9(), Live2DCubismCore.Memory.initializeAmountOfMemory(v), q = !0, Q("CubismFramework.initialize() is complete.");
  }
  /**
  ...
  static dispose() {
    ...
    d.staticReleaseNotForClientCall(), vv.release(), vv = null, f9.staticRelease(), q = !1, Q("CubismFramework.dispose() is complete.");
  }
  /**
...
class x {
  ...
  static cardanoAlgorithmForBezier(v, P, a, e) {
    ...
    const b = P / v, i = a / v, n = e / v, c = (3 * i - b * b) / 3, s = c / 3, o = (2 * b * b * b - 9 * b * i + 27 * n) / 27, g = o / 2, J = g * g + s * s * s, M = 0.5, T = M + 0.01;
    if (J < 0) {
      const C = -c / 3, bv = C * C * C, iv = this.sqrt(bv), m9 = -o / (2 * iv), y9 = this.range(m9, -1, 1), Qv = Math.acos(y9), jv = 2 * this.cbrt(iv), Nv = jv * this.cos(Qv / 3) - b / 3;
      if (this.abs(Nv - M) < T)
    ...
    const k = this.sqrt(J), rv = this.cbrt(k - g), gv = this.cbrt(k + g), h9 = rv - gv - b / 3;
...
class d9 {
  ...
  ConvertObjectToNative(v) {
    ...
    for (let e = 0; e < P; e++) {
      ...
      a += kv * Float32Array.BYTES_PER_ELEMENT;
    }
  }
...
const G9 = "Version", dv = "Meta", x9 = "SettingCount", Zv = "Dictionary", R = "Id", Tv = "Name", f = "Settings", q9 = "AnalysisType", B9 = "UseCase", p = "CubismParameters", Fv = "Min", Xv = "Max", K9 = "Damper", R9 = "Smooth", O = "AudioParameters", V9 = "Scale", Z9 = "Enabled", nv = "Mappings", F9 = "Type", Hv = "Targets", X9 = "Value", Dv = "PostProcessing", H9 = "BlendRatio", _9 = "Smoothing", $9 = "SampleRate";
class D9 {
  /**
   * コンストラクタ
  ...
  getCubismIdFromMappingTarget(v, P, a) {
    return this._json.getRoot().getValueByString(f).getValueByIndex(v).getValueByString(nv).getValueByIndex(P).getValueByString(Hv).getValueByIndex(a).getValueByString(R).getString();
  }
  /**
  ...
  getValueFromMappingTarget(v, P, a) {
    return this._json.getRoot().getValueByString(f).getValueByIndex(v).getValueByString(nv).getValueByIndex(P).getValueByString(Hv).getValueByIndex(a).getValueByString(X9).toFloat();
  }
  // --- PostProcessing ---
  /**
   * ブレンド率を取得する
      ...
      for (let o = 0; o < a.audioParameterList.getSize(); o++)
        if (b.isEqual(a.mappingList.at(o).audioId.s)) {
          for (let g = 0; g < a.cubismParameterList.getSize(); g++) {
            const J = a.mappingList.at(o).targetList.at(g);
...
var hv = /* @__PURE__ */ ((r) => (r[r.UseCase_Mouth = 0] = "UseCase_Mouth", r[r.UseCase_Unknown = 1] = "UseCase_Unknown", r))(hv || {}), mv = /* @__PURE__ */ ((r) => (r[r.MappingType_Shape = 0] = "MappingType_Shape", r[r.MappingType_Unknown = 1] = "MappingType_Unknown", r))(mv || {});
class vP {
  constructor() {
    t(this, "id");
    t(this, "name");
...
const _ = Live2DCubismMotionSyncCore.ToPointer, tP = 2, nP = 3;
class Sv {
  constructor(v = 0, P = 0) {
    t(this, "SampleRate");
    t(this, "BitDepth");
...
const h = Live2DCubismMotionSyncCore.ToPointer;
class A9 extends l9 {
...
const t9 = Live2DCubismMotionSyncCore.ToPointer;
class J9 {
  constructor() {
...
class ev {
  static initializeEngine(v) {
    let P = new J9();
    const a = P.getEngineName(), e = this.ToEngineType(a), b = P.getEngineVersion(), i = new k9(b);
...
class D {
  ...
  setSoundBuffer(v, P, a) {
    D.isInitialized() && v < this._processorInfoList.getSize() && (this._processorInfoList.at(v)._sampleBuffer = P, this._processorInfoList.at(v)._sampleBufferIndex = a);
  }
  release() {
    var v;
    if (D.isInitialized()) {
  ...
  analyze(v, P) {
    ...
    for (let J = 0; J < o && !(o == 0 || o <= b || o - b < a.getRequireSampleCount()); J += g) {
      switch (a.getType()) {
        case N.EngineType_Cri:
          i = a.Analyze(
            e,
