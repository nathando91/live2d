// node_modules/live2d-motionsync/dist/fallback.motionsync3-1oooNFSa.js
var S9 = Object.defineProperty;
var N9 = (r, v, P) => v in r ? S9(r, v, { enumerable: true, configurable: true, writable: true, value: P }) : r[v] = P;
...
function I9(r) {
  ...
  v.id = "live2dcubismmotionsynccore", v.type = "text/javascript", v.innerHTML = r, document.body.appendChild(v);
}
I9(C9);
var u = class _u {
  /**
   ...
   */
  pushBack(v) {
    this._size >= this._capacity && this.prepareCapacity(this._capacity == 0 ? _u.DefaultSize : this._capacity * 2), this._ptr[this._size++] = v;
  }
  /**
   * コンテナの全要素を解放する
   */
   ...
   */
  resize(v, P = null) {
    this.updateSize(v, P, true);
  }
  /**
   * サイズ変更
   */
  updateSize(v, P = null, a2 = true) {
    if (this._size < v)
      if (this.prepareCapacity(v), a2)
  ...
  insert(v, P, a2) {
    let e = v._index;
    const b = P._index, i = a2._index, n = i - b;
   ...
   */
  remove(v) {
    return v < 0 || this._size <= v ? false : (this._ptr.splice(v, 1), --this._size, true);
  }
  /**
...
var F = class _F {
   ...
   */
  isEqual(v) {
    return typeof v == "string" ? this._id.isEqual(v) : v instanceof j ? this._id.isEqual(v.s) : v instanceof _F ? this._id.isEqual(v._id.s) : false;
  }
  /**
   * idを比較
   * @param c 比較するid
...
var Y = class _Y {
  ...
  translateRelative(v, P) {
    ...
    _Y.multiply(a2, this._tr, this._tr);
  }
  /**
   * 現在の行列の位置を移動
   *
   ...
   */
  multiplyByMatrix(v) {
    _Y.multiply(v.getArray(), this._tr, this._tr);
  }
  /**
   * オブジェクトのコピーを生成する
   */
...
var M9 = class {
   ...
   * @param h 高さ
   */
  constructor(v, P, a2, e) {
    this.x = v, this.y = P, this.width = a2, this.height = e;
  }
  /**
   * 矩形中央のX座標を取得する
   */
...
var f9 = class {
   ...
   */
  setModelColor(v, P, a2, e) {
    v < 0 ? v = 0 : v > 1 && (v = 1), P < 0 ? P = 0 : P > 1 && (P = 1), a2 < 0 ? a2 = 0 : a2 > 1 && (a2 = 1), e < 0 ? e = 0 : e > 1 && (e = 1), this._modelColor.r = v, this._modelColor.g = P, this._modelColor.b = a2, this._modelColor.a = e;
  }
  /**
   * モデルの色を取得する
   * 各色0.0~1.0の間で指定する(1.0が標準の状態)
   ...
   */
  constructor() {
    this._isCulling = false, this._isPremultipliedAlpha = false, this._anisotropy = 0, this._model = null, this._modelColor = new g9(), this._useHighPrecisionMask = false, this._mvpMatrix4x4 = new Y(), this._mvpMatrix4x4.loadIdentity();
  }
};
var Av;
(function(r) {
...
var g9 = class {
   ...
   * コンストラクタ
   */
  constructor(v = 1, P = 1, a2 = 1, e = 1) {
    this.r = v, this.g = P, this.b = a2, this.a = e;
  }
};
var Ev;
(function(r) {
  r.CubismBlendMode = Av, r.CubismRenderer = f9, r.CubismTextureColor = g9;
})(Ev || (Ev = {}));
var Q9 = class {
  /**
   * コンストラクタ
...
var I = class _I {
   ...
   */
  appendKey(v) {
    this.prepareCapacity(this._size + 1, false), this._keyValues[this._size] = new Q9(v), this._size += 1;
  }
  /**
  ...
  getValue(v) {
    let P = -1;
    for (let a2 = 0; a2 < this._size; a2++)
      if (this._keyValues[a2].first == v) {
        P = a2;
        break;
      }
  ...
  setValue(v, P) {
    ...
    a2 >= 0 ? this._keyValues[a2].second = P : (this.appendKey(v), this._keyValues[this._size - 1].second = P);
  }
  /**
   ...
   */
  prepareCapacity(v, P) {
    v > this._keyValues.length && (this._keyValues.length == 0 ? (!P && v < _I.DefaultSize && (v = _I.DefaultSize), this._keyValues.length = v) : (!P && v < this._keyValues.length * 2 && (v = this._keyValues.length * 2), this._keyValues.length = v));
  }
  /**
   * コンテナの先頭要素を返す
   */
...
var U = class _U {
   ...
   */
  increment() {
    return new _U(this._map, this._index++);
  }
  /**
   * 後置き--演算子のオーバーロード
   */
  decrement() {
    const v = new _U(this._map, this._index);
...
var Uv;
(function(r) {
  r.csmMap = I, r.csmPair = Q9, r.iterator = U;
})(Uv || (Uv = {}));
var sv = class _sv {
  static parseJsonObject(v, P) {
    return Object.keys(v).forEach((a2) => {
      if (typeof v[a2] == "boolean") {
        const e = !!v[a2];
        P.put(a2, new L(e));
      } else if (typeof v[a2] == "string") {
        const e = String(v[a2]);
        P.put(a2, new $(e));
      } else if (typeof v[a2] == "number") {
        const e = Number(v[a2]);
        P.put(a2, new uv(e));
      } else v[a2] instanceof Array ? P.put(a2, _sv.parseJsonArray(v[a2])) : v[a2] instanceof Object ? P.put(a2, _sv.parseJsonObject(v[a2], new H())) : v[a2] == null ? P.put(a2, new X()) : P.put(a2, v[a2]);
    }), P;
  }
  static parseJsonArray(v) {
    const P = new wv();
    return Object.keys(v).forEach((a2) => {
      if (typeof Number(a2) == "number")
        if (typeof v[a2] == "boolean") {
          const b = !!v[a2];
          P.add(new L(b));
        } else if (typeof v[a2] == "string") {
          ...
          const b = Number(v[a2]);
          P.add(new uv(b));
        } else v[a2] instanceof Array ? P.add(this.parseJsonArray(v[a2])) : v[a2] instanceof Object ? P.add(this.parseJsonObject(v[a2], new H())) : v[a2] == null ? P.add(new X()) : P.add(v[a2]);
      else if (v[a2] instanceof Array)
        P.add(this.parseJsonArray(v[a2]));
      else if (v[a2] instanceof Object)
        P.add(this.parseJsonObject(v[a2], new H()));
      else if (v[a2] == null)
        P.add(new X());
      else {
        const b = Array(v[a2]);
...
var ov = "Error: type mismatch";
var p9 = "Error: index out of bounds";
var d = class y {
  /**
   * コンストラクタ
   */
   ...
   */
  getValueByIndex(v) {
    return y.errorValue.setErrorNotForClientCall(ov);
  }
  /**
   * 添字演算子[string | csmString]
   */
  getValueByString(v) {
    return y.nullValue.setErrorNotForClientCall(ov);
  }
  /**
   * マップのキー一覧をコンテナで返す
   *
  ...
  static staticInitializeNotForClientCall() {
    L.trueValue = new L(true), L.falseValue = new L(false), y.errorValue = new Pv("ERROR", true), y.nullValue = new X(), y.dummyKeys = new u();
  }
  /**
   * リリース用メソッド
   */
...
var G = class _G {
  ...
  static create(v, P) {
    const a2 = new _G();
    return a2.parseBytes(v, P, a2._parseCallback) ? a2 : (_G.delete(a2), null);
  }
  /**
  ...
  static arrayBufferToString(v) {
    ...
    for (let e = 0, b = P.length; e < b; ++e)
      a2 += "%" + this.pad(P[e].toString(16));
    return a2 = decodeURIComponent(a2), a2;
  }
  /**
   * エンコード、パディング
   */
   ...
   */
  parseBytes(v, P, a2) {
    const e = new Array(1), b = _G.arrayBufferToString(v);
    if (a2 == null ? this._root = this.parseValue(b, P, 0, e) : this._root = a2(JSON.parse(b), new H()), this._error) {
      let i = "\0";
      return i = "Json parse error : @line " + (this._lineCount + 1) + `
`, this._root = new $(i), Q("{0}", this._root.getRawString()), false;
    } else if (this._root == null)
      return this._root = new Pv(new j(this._error), false), false;
    return true;
  }
  /**
   * パース時のエラー値を返す
  ...
  parseValue(v, P, a2, e) {
    ...
    for (; i < P; i++)
      switch (v[i]) {
        ...
        case "9": {
          const s = new Array(1);
          return n = O9(v.slice(i), s), e[0] = v.indexOf(s[0]), new uv(n);
        }
        case '"':
...
`:
      ...
      const g2 = this.parseValue(v, P, n, s);
      if (this._error)
        return null;
      n = s[0], b.put(i, g2);
      v: for (; n < P; n++)
...
var uv = class extends d {
  ...
  getString(v, P) {
    const a2 = "\0";
    return this._value = parseFloat(a2), this._stringBuffer = a2, this._stringBuffer;
  }
  /**
   * 要素を数値型で返す(number)
   */
  ...
  equals(v) {
    return typeof v == "number" ? Math.round(v) ? false : v == this._value : false;
  }
};
var L = class extends d {
  ...
  equals(v) {
    return typeof v == "boolean" ? v == this._boolValue : false;
  }
  /**
   * Valueの値が静的ならtrue, 静的なら解放しない
   */
...
var $ = class extends d {
  ...
  equals(v) {
    return typeof v == "string" ? this._stringBuffer == v : v instanceof j ? this._stringBuffer == v.s : false;
  }
};
var Pv = class extends $ {
  /**
   * Valueの値が静的ならtrue、静的なら解放しない
   */
  isStatic() {
...
var wv = class extends d {
  ...
  getValueByIndex(v) {
    if (v < 0 || this._array.getSize() <= v)
      return d.errorValue.setErrorNotForClientCall(p9);
   ...
   */
  getValueByString(v) {
    return d.errorValue.setErrorNotForClientCall(ov);
  }
  /**
   * 要素を文字列で返す(csmString型)
   */
...
`;
    ...
    return this._stringBuffer = a2 + P + `]
`, this._stringBuffer;
  }
  /**
   * 配列要素を追加する
...
`;
    const a2 = this._map.begin();
    for (; a2.notEqual(this._map.end()); ) {
      const e = a2.ptr().first, b = a2.ptr().second;
...
var Gv;
(function(r) {
  r.CubismJson = G, r.JsonArray = wv, r.JsonBoolean = L, r.JsonError = Pv, r.JsonFloat = uv, r.JsonMap = H, r.JsonNullvalue = X, r.JsonString = $, r.Value = d;
})(Gv || (Gv = {}));
function O9(r, v) {
  let P = 0;
  for (let e = 1; ; e++) {
  ...
  let a2 = parseFloat(r);
  return isNaN(a2) && (a2 = NaN), v[0] = r.slice(P), a2;
}
var A = false;
var q = false;
var B = null;
var vv = null;
var W9 = Object.freeze({
  vertexOffset: 0,
  // メッシュ頂点のオフセット値
  vertexStep: 2
  // メッシュ頂点のステップ値
...
var Lv = class {
  ...
  static startUp(v = null) {
    ...
    if (B = v, B != null && Live2DCubismCore.Logging.csmSetLogFunction(B.logFunction), A = true, A) {
      const P = Live2DCubismCore.Version.csmGetVersion(), a2 = (P & 4278190080) >> 24, e = (P & 16711680) >> 16, b = P & 65535, i = P;
      Q("Live2D Cubism Core version: {0}.{1}.{2} ({3})", ("00" + a2).slice(-2), ("00" + e).slice(-2), ("0000" + b).slice(-4), i);
    }
   ...
   */
  static cleanUp() {
    A = false, q = false, B = null, vv = null;
  }
  /**
  ...
  static initialize(v = 0) {
    ...
    d.staticInitializeNotForClientCall(), vv = new u9(), Live2DCubismCore.Memory.initializeAmountOfMemory(v), q = true, Q("CubismFramework.initialize() is complete.");
  }
  /**
  ...
  static dispose() {
    ...
    d.staticReleaseNotForClientCall(), vv.release(), vv = null, f9.staticRelease(), q = false, Q("CubismFramework.dispose() is complete.");
  }
  /**
...
var xv;
(function(r) {
  r.Constant = W9, r.csmDelete = Y9, r.CubismFramework = Lv;
})(xv || (xv = {}));
var E9 = (r, v, P) => {
  j9.print(r, "[CSM]" + v, P);
};
...
var j9 = class {
   ...
   */
  static print(v, P, a2) {
    if (v < Lv.getLoggingLevel())
      return;
    const e = Lv.coreLogFunction;
    if (!e)
      return;
    const b = P.replace(/\{(\d+)\}/g, (i, n) => a2[n]);
    e(b);
  }
  /**
...
var S = class _S {
   ...
   */
  multiplyByScaler(v) {
    return this.multiply(new _S(v, v));
  }
  /**
   * ベクトルの除算
   *
   ...
   */
  divisionByScalar(v) {
    return this.division(new _S(v, v));
  }
  /**
   * ベクトルの長さを取得する
   *
...
var x = class _x {
  ...
  static cbrt(v) {
    ...
    a2 && (P = -P);
    let e;
    return P === 1 / 0 ? e = 1 / 0 : (e = Math.exp(Math.log(P) / 3), e = (P / (e * e) + 2 * e) / 3), a2 ? -e : e;
  }
  /**
   * イージング処理されたサインを求める
  ...
  static directionToRadian(v, P) {
    const a2 = Math.atan2(P.y, P.x), e = Math.atan2(v.y, v.x);
    let b = a2 - e;
    for (; b < -Math.PI; )
      b += Math.PI * 2;
    for (; b > Math.PI; )
  ...
  static directionToDegrees(v, P) {
    const a2 = this.directionToRadian(v, P);
    let e = this.radianToDegrees(a2);
   ...
   * @return  二次方程式の解
   */
  static quadraticEquation(v, P, a2) {
    return this.abs(v) < _x.Epsilon ? this.abs(P) < _x.Epsilon ? -a2 : -a2 / P : -(P + this.sqrt(P * P - 4 * v * a2)) / (2 * v);
  }
  /**
   ...
   */
  static cardanoAlgorithmForBezier(v, P, a2, e) {
    if (this.sqrt(v) < _x.Epsilon)
      return this.range(this.quadraticEquation(P, a2, e), 0, 1);
    const b = P / v, i = a2 / v, n = e / v, c = (3 * i - b * b) / 3, s = c / 3, o2 = (2 * b * b * b - 9 * b * i + 27 * n) / 27, g2 = o2 / 2, J = g2 * g2 + s * s * s, M2 = 0.5, T = M2 + 0.01;
    if (J < 0) {
      const C = -c / 3, bv = C * C * C, iv = this.sqrt(bv), m9 = -o2 / (2 * iv), y9 = this.range(m9, -1, 1), Qv = Math.acos(y9), jv = 2 * this.cbrt(iv), Nv = jv * this.cos(Qv / 3) - b / 3;
      if (this.abs(Nv - M2) < T)
        return this.range(Nv, 0, 1);
      const Cv = jv * this.cos((Qv + 2 * Math.PI) / 3) - b / 3;
      if (this.abs(Cv - M2) < T)
        return this.range(Cv, 0, 1);
      const w9 = jv * this.cos((Qv + 4 * Math.PI) / 3) - b / 3;
      return this.range(w9, 0, 1);
    }
    if (J == 0) {
      let C;
      g2 < 0 ? C = this.cbrt(-g2) : C = -this.cbrt(g2);
      const bv = 2 * C - b / 3;
      if (this.abs(bv - M2) < T)
    ...
    const k = this.sqrt(J), rv = this.cbrt(k - g2), gv = this.cbrt(k + g2), h9 = rv - gv - b / 3;
    return this.range(h9, 0, 1);
  }
  /**
   * 浮動小数点の余りを求める。
   *
  ...
  static mod(v, P) {
    ...
    const a2 = Math.abs(v), e = Math.abs(P);
    let b = a2 - Math.floor(a2 / e) * e;
...
var K = Live2DCubismMotionSyncCore.ToPointer;
var kv = 6;
var z9 = class {
  constructor(v, P, a2, e, b) {
    ...
    ), this._audioParameterId = v, this._modelParameterIds = P, this._modelParameterValues = a2, this._scale = e, this._enabled = Number(b);
  }
  toNativeArray(v) {
    ...
    const P = new Array(), a2 = new Array();
...
var Rv;
((r) => {
  r.CubismMotionSyncEngineMappingInfo = z9;
})(Rv || (Rv = {}));
var zv = Live2DCubismMotionSyncCore.ToPointer;
var N = ((r) => (r[r.EngineType_Cri = 0] = "EngineType_Cri", r[r.EngineType_Unknown = 1] = "EngineType_Unknown", r))(N || {});
var U9 = class {
  /**
...
var d9 = class {
  ...
  ConvertObjectToNative(v) {
    const P = v.getSize();
    for (let e = 0; e < P; e++)
      this._infoBufferList.pushBack(v.at(e).toNativeArray(true));
    let a2 = zv.Malloc(
      this._infoBufferList.at(0).length * P * this._infoBufferList.at(0).BYTES_PER_ELEMENT
    );
    this._mappingInfoListFirstPtr = a2;
    for (let e = 0; e < P; e++) {
      for (let b = 0; b < kv; b++)
        b == 4 ? zv.AddValuePtrFloat(
          a2,
      ...
      a2 += kv * Float32Array.BYTES_PER_ELEMENT;
    }
  }
...
var T9 = class {
  constructor(v, P, a2) {
    ...
    this._context = v, this._mapper = P, this._cubismParameterCount = a2;
  }
  release() {
    var v, P;
...
var Vv;
((r) => {
  r.MotionSyncUtil = U9, r.MotionSyncContext = T9, r.MappingInfoListMapper = d9;
})(Vv || (Vv = {}));
var G9 = "Version";
var dv = "Meta";
var x9 = "SettingCount";
...
var q9 = "AnalysisType";
var B9 = "UseCase";
var p = "CubismParameters";
var Fv = "Min";
var Xv = "Max";
var K9 = "Damper";
var R9 = "Smooth";
var O = "AudioParameters";
var V9 = "Scale";
var Z9 = "Enabled";
var nv = "Mappings";
var F9 = "Type";
...
var D9 = class {
   ...
   */
  getVersion() {
    return this._json.getRoot().getValueByString(G9).toInt();
  }
  // --- Meta ---
  /**
  ...
  getMeta() {
    let v = null;
    v = new PP(), v.settingCount = this.getSettingCount(), v.dictionary = new u();
   ...
   */
  getSettingCount() {
    return this._json.getRoot().getValueByString(dv).getValueByString(x9).toInt();
  }
  /**
   ...
   */
  getIdFromMeta(v) {
    return this._json.getRoot().getValueByString(dv).getValueByString(Zv).getValueByIndex(v).getValueByString(R).getString();
  }
  /**
   * モーションシンク設定の名前を取得する
   * @param settingIndex モーションシンク設定のインデックス
   ...
   */
  getName(v) {
    return this._json.getRoot().getValueByString(dv).getValueByString(Zv).getValueByIndex(v).getValueByString(Tv).getString();
  }
  // --- Settings ---
  /**
  ...
  getSetting(v) {
    ...
    switch (this.getUseCase(v)) {
      case "Mouth":
        P.useCase = hv.UseCase_Mouth;
        break;
      default:
        z("Unknown Settings.UseCase."), P.useCase = hv.UseCase_Unknown;
        break;
    }
   ...
   */
  getAnalysisType(v) {
    return this._json.getRoot().getValueByString(f).getValueByIndex(v).getValueByString(q9).getString();
  }
  /**
   ...
   */
  getUseCase(v) {
    return this._json.getRoot().getValueByString(f).getValueByIndex(v).getValueByString(B9).getString();
  }
  // --- CubismParametars ---
  /**
  ...
  getCubismParametarsElement(v, P) {
    const a2 = new aP();
    return a2.name = new j(
      this.getNameFromCubismParameters(v, P)
    ), a2.id = new j(
      this.getIdFromCubismParameters(v, P)
    ), a2.min = this.getMinFromCubismParameters(
      v,
      P
    ), a2.max = this.getMaxFromCubismParameters(
      v,
      P
    ), a2.damper = this.getDamperFromCubismParameters(
      v,
      P
    ), a2.smooth = this.getSmoothFromCubismParameters(
      v,
      P
    ), a2;
  }
  ...
  getNameFromCubismParameters(v, P) {
    return this._json.getRoot().getValueByString(f).getValueByIndex(v).getValueByString(p).getValueByIndex(P).getValueByString(Tv).getString();
  }
  /**
  ...
  getMinFromCubismParameters(v, P) {
    return this._json.getRoot().getValueByString(f).getValueByIndex(v).getValueByString(p).getValueByIndex(P).getValueByString(Fv).toFloat();
  }
  /**
  ...
  getMaxFromCubismParameters(v, P) {
    return this._json.getRoot().getValueByString(f).getValueByIndex(v).getValueByString(p).getValueByIndex(P).getValueByString(Xv).toFloat();
  }
  /**
  ...
  getDamperFromCubismParameters(v, P) {
    return this._json.getRoot().getValueByString(f).getValueByIndex(v).getValueByString(p).getValueByIndex(P).getValueByString(K9).toFloat();
  }
  /**
  ...
  getSmoothFromCubismParameters(v, P) {
    return this._json.getRoot().getValueByString(f).getValueByIndex(v).getValueByString(p).getValueByIndex(P).getValueByString(R9).toFloat();
  }
  // --- AudioParameters ---
  /**
  ...
  getAudioParametersElement(v, P) {
    ...
    ), a2.min = this.getMinFromAudioParameters(
      v,
      P
    ), a2.max = this.getMaxFromAudioParameters(
      v,
      P
    ), a2.scale = this.getScaleFromAudioParameters(
      v,
      P
    ), a2.enabled = this.getEnabledFromAudioParameters(
      v,
      P
    ), a2;
  }
  ...
  getNameFromAudioParameters(v, P) {
    return this._json.getRoot().getValueByString(f).getValueByIndex(v).getValueByString(O).getValueByIndex(P).getValueByString(Tv).getString();
  }
  /**
  ...
  getMinFromAudioParameters(v, P) {
    return this._json.getRoot().getValueByString(f).getValueByIndex(v).getValueByString(O).getValueByIndex(P).getValueByString(Fv).toFloat();
  }
  /**
  ...
  getMaxFromAudioParameters(v, P) {
    return this._json.getRoot().getValueByString(f).getValueByIndex(v).getValueByString(O).getValueByIndex(P).getValueByString(Xv).toFloat();
  }
  /**
  ...
  getScaleFromAudioParameters(v, P) {
    return this._json.getRoot().getValueByString(f).getValueByIndex(v).getValueByString(O).getValueByIndex(P).getValueByString(V9).toFloat();
  }
  /**
  ...
  getEnabledFromAudioParameters(v, P) {
    return this._json.getRoot().getValueByString(f).getValueByIndex(v).getValueByString(O).getValueByIndex(P).getValueByString(Z9).toBoolean();
  }
  // --- Mappings ---
  /**
   ...
   * @return マッピングデータ
   */
  getMappingsElement(v, P, a2) {
    const e = new bP();
    switch (this.getMappingType(v, P)) {
      case "Shape":
        e.type = mv.MappingType_Shape;
        break;
      default:
        z("Unknown Mappings.Type."), e.type = mv.MappingType_Unknown;
        break;
    }
    e.audioId = new j(
   ...
   * @return Targetsの要素
   */
  getMappingTargetsElement(v, P, a2) {
    const e = new rP();
    return e.id = new j(
      this.getCubismIdFromMappingTarget(v, P, a2)
   ...
   */
  getMappingType(v, P) {
    return this._json.getRoot().getValueByString(f).getValueByIndex(v).getValueByString(nv).getValueByIndex(P).getValueByString(F9).getString();
  }
  /**
   ...
   */
  getCubismIdFromMappingTarget(v, P, a2) {
    return this._json.getRoot().getValueByString(f).getValueByIndex(v).getValueByString(nv).getValueByIndex(P).getValueByString(Hv).getValueByIndex(a2).getValueByString(R).getString();
  }
  /**
   ...
   */
  getValueFromMappingTarget(v, P, a2) {
    return this._json.getRoot().getValueByString(f).getValueByIndex(v).getValueByString(nv).getValueByIndex(P).getValueByString(Hv).getValueByIndex(a2).getValueByString(X9).toFloat();
  }
  // --- PostProcessing ---
  /**
   * ブレンド率を取得する
   ...
   */
  getBlendRatio(v) {
    return this._json.getRoot().getValueByString(f).getValueByIndex(v).getValueByString(Dv).getValueByString(H9).toFloat();
  }
  /**
   * スムージング値を取得する
   * @param settingIndex モーションシンク設定のインデックス
  ...
  getSmoothingFromPostProcessing(v) {
    return this._json.getRoot().getValueByString(f).getValueByIndex(v).getValueByString(Dv).getValueByString(_9).toInt();
  }
  /**
   * 設定フレームレートを取得する
   * @param settingIndex モーションシンク設定のインデックス
   ...
   */
  getSampleRate(v) {
    return this._json.getRoot().getValueByString(f).getValueByIndex(v).getValueByString(Dv).getValueByString($9).toFloat();
  }
  // motionsync3.jsonのデータ
};
var _v;
((r) => {
  r.CubismMotionSyncDataJson = D9;
})(_v || (_v = {}));
var av = class _av {
  /**
   * コンストラクタ
   ...
   * @return 作成されたインスタンス
   */
  static create(v, P, a2) {
    const e = new _av();
    return e.parse(v, P, a2), e;
  }
  /**
   * インスタンスを破棄する
  ...
  getMappingInfoList(v) {
    if (this._settings.getSize() <= v)
      return null;
    const P = new u(), a2 = this.getSetting(v);
    for (let e = 0; e < a2.audioParameterList.getSize(); e++) {
      const b = a2.audioParameterList.at(e).id, i = new u(), n = new u();
      for (let o2 = 0; o2 < a2.audioParameterList.getSize(); o2++)
        if (b.isEqual(a2.mappingList.at(o2).audioId.s)) {
          for (let g2 = 0; g2 < a2.cubismParameterList.getSize(); g2++) {
            const J = a2.mappingList.at(o2).targetList.at(g2);
            i.pushBack(J.id), n.pushBack(J.value);
          }
          break;
        }
      const c = a2.audioParameterList.at(e).scale, s = a2.audioParameterList.at(e).enabled;
      P.pushBack(
        new z9(
          b,
          i,
...
var hv = ((r) => (r[r.UseCase_Mouth = 0] = "UseCase_Mouth", r[r.UseCase_Unknown = 1] = "UseCase_Unknown", r))(hv || {});
var mv = ((r) => (r[r.MappingType_Shape = 0] = "MappingType_Shape", r[r.MappingType_Unknown = 1] = "MappingType_Unknown", r))(mv || {});
var vP = class {
  constructor() {
    t(this, "id");
    t(this, "name");
...
var V = Live2DCubismMotionSyncCore.ToPointer;
var yv = class {
  constructor(v) {
    t(this, "_values");
    t(this, "_valuesCount");
...
var v9;
((r) => {
  r.CubismMotionSyncEngineAnalysisResult = yv;
})(v9 || (v9 = {}));
var l9 = class {
  constructor(v, P, a2) {
    t(this, "_engine");
    ...
    this._engine = v, this._contextHandle = P, this._mappingInfoArray = a2;
  }
  /**
   * createAnalysisResult
   */
  createAnalysisResult() {
    return this.isClosed() || this._mappingInfoArray.getSize() < 1 ? new yv(0) : new yv(
...
var _ = Live2DCubismMotionSyncCore.ToPointer;
var tP = 2;
var nP = 3;
var Sv = class {
  constructor(v = 0, P = 0) {
  ...
  toNativeArray(v) {
    !v && this._nativeArray || (this._nativeArray && this.releaseNativeArray(), this._nativeArray = new Int32Array(tP), this._nativeArrayPtr = _.Malloc(
      this._nativeArray.length * this._nativeArray.BYTES_PER_ELEMENT
...
var cP = class {
  constructor(v = 0, P = 0, a2 = 0) {
    t(this, "BlendRatio");
    t(this, "Smoothing");
    t(this, "AudioLevelEffectRatio");
    t(this, "_nativeArray");
    t(this, "_nativeArrayPtr");
    this.BlendRatio = v, this.Smoothing = P, this.AudioLevelEffectRatio = a2;
  }
  toNativeArray(v) {
    return !v && this._nativeArray ? this._nativeArray : (this._nativeArray && this.releaseNativeArray(), this._nativeArray = new Float32Array(nP), this._nativeArrayPtr = _.Malloc(
      this._nativeArray.length * this._nativeArray.BYTES_PER_ELEMENT
...
var h = Live2DCubismMotionSyncCore.ToPointer;
var A9 = class extends l9 {
  constructor(P, a2, e, b, i) {
    super(P, a2, e);
    t(this, "_sampleRate");
    t(this, "_bitDepth");
  ...
  Analyze(P, a2, e, b, i, n) {
    ...
    (!this._analysisConfigNativePtr || this._analysisConfigNativePtr == 0) && (this._analysisConfigNativePtr = h.Malloc(
      o2.length
    )), h.AddValuePtrFloat(
    ...
    const g2 = n.toNativeArray(false);
    return (!this._analysisResultNativePtr || this._analysisResultNativePtr == 0) && (this._analysisResultNativePtr = h.Malloc(
      g2.length * g2.BYTES_PER_ELEMENT
    )), h.AddValuePtrInt32(
  ...
  release() {
    h.Free(this._analysisConfigNativePtr), this._analysisConfigNativePtr = 0, h.Free(this._analysisResultNativePtr), this._analysisResultNativePtr = 0;
  }
};
var e9;
((r) => {
  r.CubismMotionSyncProcessorCRI = A9;
})(e9 || (e9 = {}));
var r9 = 32;
var L9 = class {
  constructor(v, P, a2, e) {
    ...
    t(this, "_name");
    t(this, "_version");
    this._engineHandle = v, this._type = P, this._name = a2, this._version = e;
  }
  getType() {
    return this._type;
  }
...
var b9;
((r) => {
  r.ICubismMotionSyncEngine = L9;
})(b9 || (b9 = {}));
var sP = 16e3;
var oP = 128e3;
var uP = class extends L9 {
  constructor(P, a2, e, b) {
    super(P, a2, e, b);
    t(this, "_processors");
    this._processors = new u();
  }
  CreateProcessor(P, a2, e) {
    if (this.isClosed())
      return z(
...
var t9 = Live2DCubismMotionSyncCore.ToPointer;
var J9 = class {
  constructor() {
  ...
  initializeEngine(v) {
    return this.isInitialized() ? (Q("Cubism MotionSync Core already initialized."), true) : (this._isEngineInitialized = false, Live2DCubismMotionSyncCore.CubismMotionSyncEngine.csmMotionSyncInitializeEngine(
      v
    ) == Live2DCubismMotionSyncCore.csmMotionSyncFalse ? (z("Cubism MotionSync Core Initializing failed."), false) : (this._isEngineInitialized = true, true));
  }
  disposeEngine() {
    ...
    Live2DCubismMotionSyncCore.CubismMotionSyncEngine.csmMotionSyncDisposeEngine(), this._isEngineInitialized = false;
  }
  createContext(v, P, a2, e) {
    if (!this.isInitialized())
    ...
    switch (v) {
      case N.EngineType_Cri:
        {
          const n = P;
          n == null || n.toNativeArray(true), i = n == null ? void 0 : n.getNativePtr();
        }
        break;
      default:
        return null;
  ...
  analyze(v, P, a2, e, b, i) {
    if (!this.isInitialized())
      return Q("Cubism MotionSync Core initialized yet."), false;
    if (v == null)
      return Q("context is null."), false;
    const n = new Array(e);
    for (let s = 0; s < e; s++)
      n[s] = P[s + a2];
    return t9.Free(this._analyzeSamplesPtr), this._analyzeSamplesPtr = t9.ConvertNumberArrayToFloatArrayPtr(n), v.csmMotionSyncAnalyze(
...
var n9;
((r) => {
  r.CubismMotionSyncEngineLib = J9;
})(n9 || (n9 = {}));
var k9 = class {
  constructor(v) {
...
var ev = class {
  static initializeEngine(v) {
    let P = new J9();
    const a2 = P.getEngineName(), e = this.ToEngineType(a2), b = P.getEngineVersion(), i = new k9(b);
    if (this._engineMap || (this._engineMap = new I()), this._engineMap.isExist(e) || (Q(a2.s + " " + i.toString()), !P.initializeEngine(v)))
...
var D = class _D {
  constructor(v, P, a2) {
    ...
    for (let e = 0; e < (a2 == null ? void 0 : a2.getSize()); e++)
  ...
  static startUp(v = null) {
    return m ? (Q("CubismMotionSyncFramework.startUp() is already done."), m) : (W = v, W != null && Live2DCubismMotionSyncCore.Logging.csmMotionSyncSetLogFunction(
      W.logFunction
    ), m = true, Q("CubismMotionSyncFramework.startUp() is complete."), m);
  }
  /**
  ...
  static initialize() {
    ...
    Z = true, Q("CubismMotionSyncFramework.initialize() is complete.");
  }
  /**
  ...
  static dispose() {
    ...
    Z = false, Q("CubismMotionSyncFramework.dispose() is complete.");
  }
  /**
  ...
  static InitializeEngineCri(v, P, a2, e) {
    let b = ev.getEngine(v);
    W.engineConfig != null && (w = new gP(), w.engineConfigBuffer = new Int32Array(
      fP
    ...
    return b && (n = b.CreateProcessor(
      P.getSetting(a2).cubismParameterList.getSize(),
      P.getMappingInfoList(a2),
      e
    )), n;
  }
  static delete(v) {
  ...
  setSoundBuffer(v, P, a2) {
    _D.isInitialized() && v < this._processorInfoList.getSize() && (this._processorInfoList.at(v)._sampleBuffer = P, this._processorInfoList.at(v)._sampleBufferIndex = a2);
  }
  release() {
    var v;
    if (_D.isInitialized()) {
  ...
  updateParameters(v, P) {
    if (_D.isInitialized()) {
      P < 0 && (P = 0);
      for (let a2 = 0; a2 < this._processorInfoList.getSize(); a2++) {
        this._processorInfoList.at(a2)._currentRemainTime += P;
        const b = 1 / this._processorInfoList.at(a2)._sampleRate;
        if (this._processorInfoList.at(a2)._lastTotalProcessedCount = 0, this._processorInfoList.at(a2)._currentRemainTime < b) {
          for (let i = 0; i < this._data.getSetting(a2).cubismParameterList.getSize(); i++)
            isNaN(
              this._processorInfoList.at(a2)._analysisResult.getValues()[i]
            ) || v.setParameterValueByIndex(
              this._data.getSetting(a2).cubismParameterList.at(i).parameterIndex,
              this._processorInfoList.at(a2)._lastDampedList.at(i)
            );
          continue;
        }
        this.analyze(v, a2), this._processorInfoList.at(a2)._currentRemainTime = x.mod(
          this._processorInfoList.at(a2)._currentRemainTime,
          b
        );
        for (let i = 0; i < this._data.getSetting(a2).cubismParameterList.getSize(); i++)
          isNaN(
  ...
  analyze(v, P) {
    if (!_D.isInitialized())
      return;
    const a2 = this._processorInfoList.at(P)._processor, e = this._processorInfoList.at(P)._sampleBuffer;
    let b = this._processorInfoList.at(P)._sampleBufferIndex;
    if (a2 == null || this._processorInfoList.at(P)._sampleBuffer == null)
      return;
    let i = null;
    const n = this._processorInfoList.at(P)._blendRatio, c = this._processorInfoList.at(P)._smoothing, s = this._processorInfoList.at(P)._audioLevelEffectRatio, o2 = e.getSize();
    let g2 = a2.getRequireSampleCount();
    for (let J = 0; J < o2 && !(o2 == 0 || o2 <= b || o2 - b < a2.getRequireSampleCount()); J += g2) {
      switch (a2.getType()) {
        case N.EngineType_Cri:
          i = a2.Analyze(
            e,
      ...
      if (!i)
        break;
      const M2 = i.getProcessedSampleCount();
      b += M2, this._processorInfoList.at(P)._lastTotalProcessedCount += M2;
      for (let T = 0; T < this._data.getSetting(P).cubismParameterList.getSize(); T++) {
        let k = i.getValues()[T];
        if (isNaN(k))
          continue;
        const rv = this._data.getSetting(P).cubismParameterList.at(T).smooth, gv = this._data.getSetting(P).cubismParameterList.at(T).damper;
        k = ((100 - rv) * k + this._processorInfoList.at(P)._lastSmoothedList.at(T) * rv) / 100, this._processorInfoList.at(P)._lastSmoothedList.set(T, k), Math.abs(
          k - this._processorInfoList.at(P)._lastDampedList.at(T)
        ) < gv && (k = this._processorInfoList.at(P)._lastDampedList.at(T)), this._processorInfoList.at(P)._lastDampedList.set(T, k);
      }
      g2 = a2.getRequireSampleCount();
    }
  }
  setBlendRatio(v, P) {
    _D.isInitialized() && v < this._processorInfoList.getSize() && (this._processorInfoList.at(v)._blendRatio = P);
  }
  SetSmoothing(v, P) {
    _D.isInitialized() && v < this._processorInfoList.getSize() && (this._processorInfoList.at(v)._smoothing = P);
  }
  SetSampleRate(v, P) {
    _D.isInitialized() && v < this._processorInfoList.getSize() && (this._processorInfoList.at(v)._sampleRate = P);
  }
  getData() {
    return this._data;
  }
...
var QP = class {
  constructor(v, P, a2) {
    ...
    this._processor = v, this._blendRatio = 0, this._smoothing = 1, this._sampleRate = 30, this._audioLevelEffectRatio = 0, this._sampleBuffer = null, this._sampleBufferIndex = 0, this._model = P, this._currentRemainTime = 0, this._lastTotalProcessedCount = 0, this.init(a2), this._analysisResult = this._processor.createAnalysisResult();
  }
  init(v) {
    ...
    for (let P = 0; P < v.cubismParameterList.getSize(); P++) {
      const a2 = this._model.getParameterValueByIndex(
        v.cubismParameterList.at(P).parameterIndex
      );
      this._lastSmoothedList.pushBack(a2), this._lastDampedList.pushBack(a2);
    }
...
// node_modules/live2d-motionsync/dist/stream.es.js
var h2 = Object.defineProperty;
var d2 = (s, t2, e) => t2 in s ? h2(s, t2, { enumerable: true, configurable: true, writable: true, value: e }) : s[t2] = e;
var o = (s, t2, e) => d2(s, typeof t2 != "symbol" ? t2 + "" : t2, e);
var m2 = `/**
 * Copyright(c) Live2D Inc. All rights reserved.
 *
...
var g = class {
  constructor(t2) {
    ...
    o(this, "_source", null);
    o(this, "_buffer", null);
    this._internalModel = t2, this._model = t2.coreModel, D.startUp(new dP()), D.initialize();
  }
  async play(t2) {
    (this._source || this._context) && this.reset();
    const e = t2.getAudioTracks();
    if (e.length == 0) {
      l("没有找到音频轨道.");
      return;
    }
    ...
    await this._context.audioWorklet.addModule(l2);
    const u2 = new AudioWorkletNode(
      this._context,
      "lappaudioworkletprocessor"
    );
    this._source.connect(u2), u2.port.onmessage = this.onMessage.bind(this);
  }
  async reset() {
  ...
  resetMouthStatus() {
    try {
      ...
      const t2 = this._motionSync.getData().getSetting(0);
      if (!t2) return;
      const e = t2.cubismParameterList;
      if (!e) return;
      const n = e._ptr.map(
        (i) => i.parameterIndex
      );
  ...
  pop() {
    if (!this._buffer)
      return;
    const t2 = this._buffer.toVector();
    return this._buffer.clear(), t2;
  }
  onMessage(t2) {
    const e = t2.data;
  ...
  updateMotionSync() {
    const t2 = performance.now() / 1e3, e = this.pop();
    e && (this._motionSync.setSoundBuffer(0, e, 0), this._motionSync.updateParameters(this._model, t2));
  }
  ...
  loadMotionSync(t2, e = a) {
    if (t2 == null || t2.byteLength == 0) {
  ...
  async loadDefaultMotionSync(t2 = a) {
    const n = await new Blob([TP], { type: "application/json" }).arrayBuffer();
    this.loadMotionSync(n, t2);
  }
  async loadMotionSyncFromUrl(t2, e = a) {
    try {
      const i = await (await fetch(t2)).arrayBuffer();
...
var M = class {
  constructor(t2) {
    ...
    o(this, "_size");
    o(this, "_head");
    this._buffer = new Float32Array(t2), this._size = 0, this._head = 0;
  }
  get size() {
    return this._size;
  }
  addLast(t2) {
    this._buffer[this._head] = t2, this._size = Math.min(this._size + 1, this._buffer.length), this._head++, this._head >= this._buffer.length && (this._head = 0);
  }
  toVector() {
    const t2 = new u(this._size);
    let e = this._head - this._size;
    e < 0 && (e += this._buffer.length);
    for (let n = 0; n < this._size; n++)
      t2.pushBack(this._buffer[e]), e++, e >= this._buffer.length && (e = 0);
    return t2;
  }
  clear() {
...
//# sourceMappingURL=live2d-motionsync_stream.js.map
